...
final readonly class RaffleStarted implements AggregateEventInterface
{
    public const string EVENT_NAME = 'raffle.started';
    ...
    public static function deserialize(string $serialized): AggregateEventInterface
    {
         ...
         *     aggregateId: string,
         *     started: array{by: string, at:string},
         *     occurredAt: string
         * } $event
         */
        ...
        return new self(
            ...
            Started::fromArray($event['started']),
