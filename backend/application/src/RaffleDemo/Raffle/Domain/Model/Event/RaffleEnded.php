...
final readonly class RaffleEnded implements AggregateEventInterface
{
    public const string EVENT_NAME = 'raffle.ended';
    ...
    public static function deserialize(string $serialized): AggregateEventInterface
    {
         ...
         *     aggregateId: string,
         *     ended: array{by: string, at:string, reason: string},
         *     occurredAt: string
         * } $event
         */
