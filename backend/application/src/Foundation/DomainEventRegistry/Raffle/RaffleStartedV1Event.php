...
final readonly class RaffleStartedV1Event implements DomainEventInterface
{
    private const string TYPE = 'raffle_demo.raffle.started.v1';
    ...
    public static function fromPayload(string $eventId, DateTimeInterface $eventOccurredAt, array $payload): self
    {
        return new self(
            ...
            startedAt: Clock::fromString($payload['startedAt']),
