...
final readonly class RaffleEndedV1Event implements DomainEventInterface
{
    private const string TYPE = 'raffle_demo.raffle.ended.v1';
    ...
    public static function fromPayload(string $eventId, DateTimeInterface $eventOccurredAt, array $payload): self
    {
        return new self(
            ...
            endedAt: Clock::fromString($payload['endedAt']),
