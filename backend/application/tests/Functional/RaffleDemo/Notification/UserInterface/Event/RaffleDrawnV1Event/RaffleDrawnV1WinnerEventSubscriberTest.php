...
use App\RaffleDemo\Notification\UserInterface\Event\RaffleDrawnV1Event\RaffleDrawnV1WinnerEventSubscriber;
use App\Tests\Functional\AbstractFunctionalTestCase;
use PHPUnit\Framework\Attributes\Test;

final class RaffleDrawnV1WinnerEventSubscriberTest extends AbstractFunctionalTestCase
{
    private NotificationRepositoryInterface $repository;
    private RaffleDrawnV1WinnerEventSubscriber $subscriber;
    ...
    protected function setUp(): void
    {
        ...
        $this->subscriber = self::getContainer()->get(RaffleDrawnV1WinnerEventSubscriber::class);
    }
    ...
    public function it_handles_an_incoming_event(): void
    {
        ...
        // Assert
        $notifications = $this->repository->getByRecipient(EmailAddress::fromString($event->winningAllocationTo));
        self::assertCount(1, $notifications);
        self::assertStringContainsString('drawn.winner', $notifications[0]->type->toString());
    }
}
